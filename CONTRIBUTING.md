# Contributing to labplan

Thank you for considering a contribution. This project follows one rule
above all others, the same rule its releases follow:

**A change that touches the statistics arrives with a test, and a
claim arrives with its source.**

## Reporting problems

Open an issue at https://github.com/TaN-MM-Org/labplan/issues. For a
...
3. New statistics or new behavior needs a new test that fails without your
